...
public class Vector implements Cloneable {
     ...
     * {@code calcLength()}, после чего длина не рассчитывается заново.
     *
     * @see #calcedLength
     */
     ...
     * @see #length
     */
    protected boolean calcedLength;

    /**
     * Кэширующее поле, содержащее квадрат длины вектора. Изначально значение
     * равно нулю. Инициализируется вызовом методов
     * {@code length()}, {@code calcLength()}, {@code sqLength()} или
     * {@code calcSqLength()}, после чего длина не рассчитывается заново.
     *
     * @see #calcedSqLength
     */
     ...
     * @see #sqLength
     */
    protected boolean calcedSqLength;
    ...
    /**
     * Обеспечивает доступ к полю {@code calcedLength}.
     *
     * @see #calcedLength
     * @return значение поля {@code calcedLength}.
     */
    public boolean calcedLength() {
        return calcedLength;
    }
    ...
    /**
     * Обеспечивает доступ к полю {@code calcedSqLength}.
     *
     * @see #calcedSqLength
     * @return значение поля {@code calcedSqLength}.
     *
     */
    public boolean calcedSqLength() {
        return calcedSqLength;
    }
     ...
     * {@code calcSqLength()}, {@code calcLength()} или {@code length()}. В
